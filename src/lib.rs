...
pub static ECMULT_CONTEXT: ECMultContext = unsafe {
    ECMultContext::new_from_raw(
...
pub static ECMULT_GEN_CONTEXT: ECMultGenContext = unsafe {
    ECMultGenContext::new_from_raw(
...
pub fn recover_with_context(
    ...
    context.recover_raw(&signature.r, &signature.s, recovery_id.0, &message.0)
        .map(|v| PublicKey(v))
}
